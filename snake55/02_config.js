;(function (global) {
	...
	RENDER: {
		...
		fireField: { alpha: 0.18 },
		fireVfx: {
			emberIntervalSec: { HIGH: 0.18, MED: 0.28, LOW: 0.42 },
			emberMax: { HIGH: 8, MED: 5, LOW: 2 },
			emberLifeMin: 0.28,
			emberLifeMax: 0.42,
			emberOuterLengthMin: 5,
			emberOuterLengthMax: 9,
			emberOuterWidth: 2.5,
			emberInnerLengthRatio: 0.62,
			emberInnerWidth: 1.3,
			emberOuterColor: '#ff7a2f',
			emberInnerColor: '#ffd27a',
			emberDriftX: 10,
			emberRiseMin: 26,
			emberRiseMax: 42,
			emberJitter: 4,
