;(function (global) {
	...
	var CONFIG = {
		...
		SKILL: {
			...
			fire: { dotPerSec: [6, 9, 13, 18, 24], radius: [40, 50, 60, 72, 85], lv5: 'spreadBurn' },
			ice: { slowPct: [0.20, 0.30, 0.40, 0.50, 0.60], trailWidth: [20, 26, 32, 40, 50], lv5FreezeSec: 1.0 },
			...
			shield: { count: [1, 2, 3, 4, 5], contactDamage: [8, 11, 14, 18, 22], lv5: 'reflect' },
