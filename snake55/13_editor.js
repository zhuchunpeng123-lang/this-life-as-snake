;(function (global) {
	...
	var UI_TUNING = [
		...
		{ group: '06 Boss', path: 'UI.tuning.bossBar.heightPx', label: 'Boss 框高度', rng: 'px' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.offsetY', label: 'Boss 框偏移', rng: 'offset' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.labelPx', label: 'Boss 旧标签字号', rng: 'font' },
		...
		{ group: '06 Boss', path: 'UI.tuning.bossBar.timeX', label: 'Boss 时间 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.timeY', label: 'Boss 时间 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.timeSize', label: 'Boss 时间字号', rng: 'font' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.phaseX', label: 'Boss 阶段 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.phaseY', label: 'Boss 阶段 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.phaseSize', label: 'Boss 阶段字号', rng: 'font' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.statusX', label: 'Boss 状态 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.statusY', label: 'Boss 状态 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.statusSize', label: 'Boss 状态字号', rng: 'font' },
