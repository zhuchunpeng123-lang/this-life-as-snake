;(function (global) {
	...
	var RANGE = {
		snakeSpeed: [80, 400, 5], turnRate: [60, 360, 5], turnRateDecay: [0, 1.0, 0.01], turnRateFloor: [100, 150, 1], maxSegments: [5, 60, 1], playerRadius: [8, 40, 1],   // 蛇头/身半径滑条专用范围（headRadius 默认14 / bodyRadius 默认12；最小 8 与 collision.MIN_JUDGE_R 对齐，源头避免拖出过小判定半径导致「吃不到食物」；L2 实时：拖动即时生效 RT桥→视觉 + Bus(collision:set_radii)→判定/墙碰，同时写 override 供「保存并重载」持久）
	...
	var diagWhiteOn = false, diagShakeOn = false, diagFireOn = false, diagIceFillOn = false, diagHudOn = false   // b9-diag：T1 关白爆 / T2 关屏震 / T3 关火焰系视觉 / T4 冰池只描边 / 性能HUD(精简) 开关态
	...
	var UI_TUNING = [
		...
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.labelSize', label: 'Stats label size', rng: 'font' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.valueSize', label: 'Stats value size', rng: 'font' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.labelValueGap', label: 'Stats label/value gap', rng: 'px' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.lengthOffsetX', label: 'Length X offset', rng: 'normOffset' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.killsOffsetX', label: 'Kills X offset', rng: 'normOffset' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.scoreOffsetX', label: 'Score X offset', rng: 'normOffset' },
		{ group: '02 Player Stats', path: 'UI.tuning.playerStats.streakOffsetX', label: 'Streak X offset', rng: 'normOffset' },
		...
		{ group: '05 Combo', path: 'UI.tuning.combo.icon1OffsetX', label: 'Combo 1 图标 X', rng: 'offset' },
		{ group: '05 Combo', path: 'UI.tuning.combo.icon1OffsetY', label: 'Combo 1 图标 Y', rng: 'offset' },
		{ group: '05 Combo', path: 'UI.tuning.combo.icon2OffsetX', label: 'Combo 2 图标 X', rng: 'offset' },
		{ group: '05 Combo', path: 'UI.tuning.combo.icon2OffsetY', label: 'Combo 2 图标 Y', rng: 'offset' },
		{ group: '05 Combo', path: 'UI.tuning.combo.icon3OffsetX', label: 'Combo 3 图标 X', rng: 'offset' },
		{ group: '05 Combo', path: 'UI.tuning.combo.icon3OffsetY', label: 'Combo 3 图标 Y', rng: 'offset' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.widthPct', label: 'Boss 框宽度', rng: 'bossWidth' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.maxWidthPx', label: 'Boss 框最大宽度', rng: 'bossMax' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.offsetY', label: 'Boss 框偏移', rng: 'offset' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.nameX', label: 'Boss 名称 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.nameY', label: 'Boss 名称 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.nameSize', label: 'Boss 名称字号', rng: 'font' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.subtitleX', label: 'Boss 副标题 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.subtitleY', label: 'Boss 副标题 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.subtitleSize', label: 'Boss 副标题字号', rng: 'font' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.hpX', label: 'Boss 血条 X', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.hpY', label: 'Boss 血条 Y', rng: 'normPos' },
		{ group: '06 Boss', path: 'UI.tuning.bossBar.hpWidth', label: 'Boss 血条宽度', rng: 'progressWidth' },
