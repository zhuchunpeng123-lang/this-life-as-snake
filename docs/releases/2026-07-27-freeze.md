...
> 配套：AGENTS.md（守则）、CHANGELOG.md（改动流水）、docs/DEBT.md（债台账）、docs/plans/STATUS.md（计划索引）、`2026-07-27-codebuddy-handoff.md`（交接圣经）。
...
> 封版即交接基线。`2026-07-27-codebuddy-handoff.md` 是给 Codex 的详尽圣经，读完即可独立开工。
